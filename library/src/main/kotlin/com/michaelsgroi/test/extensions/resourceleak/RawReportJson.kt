...
internal object RawReportJson {
    ...
    fun encodeSnapshot(snapshot: Snapshot): String =
        obj(
    ...
    private fun array(elements: List<String>): String = elements.joinToString(",", prefix = "[", postfix = "]")
